  ...
  var Carousel = _React['default'].createClass({
    ...
    renderPrev: function renderPrev() {
      return _React['default'].createElement(
        ...
        _React['default'].createElement('span', { className: 'glyphicon glyphicon-chevron-left' })
      );
    },
    ...
    renderNext: function renderNext() {
      return _React['default'].createElement(
        ...
        _React['default'].createElement('span', { className: 'glyphicon glyphicon-chevron-right' })
      );
    },
