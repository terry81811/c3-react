define(['exports', 'module', 'react', './InputBase', './ButtonInput', './FormControls', './utils/deprecationWarning'], function (exports, module, _react, _InputBase2, _ButtonInput, _FormControls, _utilsDeprecationWarning) {
  'use strict';
    ...
    _createClass(Input, [{
      ...
      value: function render() {
        if (_ButtonInput2['default'].types.indexOf(this.props.type) > -1) {
          (0, _deprecationWarning['default'])('Input type=' + this.props.type, 'ButtonInput');
          return _React['default'].createElement(_ButtonInput2['default'], this.props);
